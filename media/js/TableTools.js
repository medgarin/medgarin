...
TableTools.BUTTONS = {
	...
	"copy": {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			alert( 'Copiadas '+len+' columna'+plural+' a el portapapeles' );
		},
		"fnInit": null,
		"fnCellRender": null
	},
	...
	"print": {
		"sAction": "print",
		"sInfo": "<h6>Vista de impresion</h6><p>Por favor usa las funciones de tu navegador para"+
		  "imprimir la tabla. Presiona Esc para salir.",
		"sMessage": "",
		"bShowAll": true,
